...
The first step is to analyze the application. Then, view page source. This can be done by right-clicking the page and selecting "View Page Source", or by using developer tools.
